...
class Config(object):
    """
    this class to Configuration for Babel
    """
    LANGUAGES = ["en", "fr"]
...
def get_user() -> Union[Dict, None]:
    """
    func to Returns a user dictionary or None if ID value can't be found
    """
...
def before_request():
    """
    func to Add user to flask.g if user is found
    """
    user = get_user()
    g.user = user
...
def get_locale():
    """
    func to Select and return best language match based on supported languages
    """
...
def get_timezone():
    """
    func to Select and return appropriate timezone
    """
